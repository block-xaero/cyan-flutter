    ...
    showMenu<String>(
      ...
      items: <PopupMenuEntry<String>>[
        const PopupMenuItem<String>(
          value: 'rename',
          child: Text('Rename', style: TextStyle(color: Color(0xFFF8F8F2))),
        ),
        const PopupMenuItem<String>(
          value: 'new_workspace',
          child: Text('New Workspace', style: TextStyle(color: Color(0xFFF8F8F2))),
        ),
        const PopupMenuDivider(),
        const PopupMenuItem<String>(
          value: 'open_chat',
          child: Text('Open Group Chat', style: TextStyle(color: Color(0xFFF8F8F2))),
        ),
        const PopupMenuDivider(),
        const PopupMenuItem<String>(
          value: 'delete',
          child: Text('Delete', style: TextStyle(color: Color(0xFFF92672))),
        ),
      ],
    ).then((value) {
