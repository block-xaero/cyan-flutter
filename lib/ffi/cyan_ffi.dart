...
class CyanFFI {
  ...
  /// Check if backend is ready (private helper)
  bool _checkReady() {
  ...
  /// Check if backend is ready (instance getter for _ffi.isReady)
  bool get isReady => _checkReady();
  
  /// Seed demo data (private helper)
  bool _seedDemo() {
    if (!_initialized || _seedDemoFn == null) return false;
    return _seedDemoFn!();
  }
  
  /// Seed demo data if empty (instance method for _ffi.seedDemoIfEmpty())
  bool seedDemoIfEmpty() => _seedDemo();
